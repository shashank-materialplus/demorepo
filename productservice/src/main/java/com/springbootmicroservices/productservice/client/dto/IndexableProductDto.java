package com.springbootmicroservices.productservice.client.dto;
...
/**
 * DTO representing a product's data being sent to the Search Service.
 * This must match the structure expected by search-service's IndexableProduct.
 */
@Getter
@Setter
@Builder
public class IndexableProductDto {
