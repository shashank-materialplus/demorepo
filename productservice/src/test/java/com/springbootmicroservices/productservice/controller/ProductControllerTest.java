...
class ProductControllerTest extends AbstractRestControllerTest {
    ...
    void givenProductId_whenGetProductByIdFromAdmin_thenReturnProductResponse() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/products/{productId}", productId)
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.response.description").value(productResponse.getDescription()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.response.authorName").value(productResponse.getAuthorName()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.response.imageUrl").value(productResponse.getImageUrl()));
    ...
    void givenProductPagingRequest_whenGetProductsFromAdmin_thenReturnCustomPageProduct() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/products")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.response.content[0].description").value(expected.getDescription()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.response.content[0].authorName").value(expected.getAuthorName()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.response.content[0].imageUrl").value(expected.getImageUrl()));
    ...
    void givenProductUpdateRequest_WhenUpdateProductByFromAdmin_thenReturnUpdatedProduct() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/api/v1/products/{productId}", productId)
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.response.description").value(updatedProduct.getDescription()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.response.authorName").value(updatedProduct.getAuthorName()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.response.imageUrl").value(updatedProduct.getImageUrl()));
